...
class FireFlower(Powerup):
    ...
    def update(self, level):
        ...
        if self.current_time - self.timer > 35:
            self.frame_index += 1
...
class Fireball(Powerup):
    def __init__(self, centerx, centery, direction):
        frame_rects = [(96, 144, 8, 8), (104, 144, 8, 8), (96, 152, 8, 8), (104, 152, 8, 8), # rotation
                       (112, 144, 16, 16), (112, 160, 16, 16), (112, 176, 16, 16)] # explosion
        Powerup.__init__(self, centerx, centery, frame_rects)
        self.name = "fireball"
        self.state = "fly"
